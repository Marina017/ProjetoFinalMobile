...
public class HomeFragment extends Fragment {
    ...
    public void onResume() {
        super.onResume();
        // Atualiza a lista sempre que voltar para a Home (ex: após cadastrar)
        if (adapter != null) {
    ...
    private void carregarDados() {
        List<Remedio> lista = RemedioRepository.getLista();

        // Preenche os remédios iniciais somente na primeira vez (lista vazia)
        if (lista.isEmpty()) {
